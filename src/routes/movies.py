...
@router.get(
    ...
    responses={
        status.HTTP_404_NOT_FOUND: {"detail": "Movie with the given ID was not found."},
    },
)
async def get_movie(
    movie_id: int,
...
@router.delete("/movies/{movie_id}/", status_code=HTTP_204_NO_CONTENT)
...
@router.patch("/movies/{movie_id}/", status_code=HTTP_200_OK)
